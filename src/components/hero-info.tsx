    ...
    <HeroHighlight>
      ...
      >
        ...
        <div className="flex flex-col mt-8 mb-4 md:mt-16 lg:mb-14 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          ...
          <a
            href="#"
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-orange-400 hover:bg-slate-600 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
          >
            Book now
            <svg
