...
export default function Landing() {
  return (
    <div className="flex flex-col gap-20">
      <section className="flex flex-col lg:flex-row items-start sm:items-center justify-between xl:ml-[6rem] xl:mr-[6rem]">
        <div className="flex flex-col gap-4 p-4 w-full lg:w-[30%]">
        ...
        <div className="p-4 w-full lg:w-[70%] h-full">
          <Image
